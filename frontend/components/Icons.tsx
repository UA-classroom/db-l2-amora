...
export const GarageIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
     <path strokeLinecap="round" strokeLinejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V9.618a1 1 0 01.553-.894L9 6m0 14v-2m-1.447-12.276a1 1 0 011.389 0l5.447 2.724A1 1 0 0121 9.618v6.764a1 1 0 01-.553.894L15 20m-6-14v-2m1.447 12.276L15 16m-6-10l6-3m-6 10l6 3" />
  </svg>
);
